...
Shader "Retus001/CellShaded" {
    Properties {
        ...
        _OutlinePower ("OutlinePower", Range(0, 1)) = 0
...
////// Emissive:
                ...
                float3 node_5592 = Specular;
                float3 node_8672 = saturate((node_5673+node_5592));
                ...
                float3 _useFresnel_var = lerp( node_8672, saturate((1.0-(1.0-node_8672)*(1.0-(FresnelCustom*Shadow)))), _useFresnel );
                float node_9548_if_leA = step(_useFresnel_var,_CellShadingBalance);
                float node_9548_if_leB = step(_CellShadingBalance,_useFresnel_var);
                ...
                float3 finalColor = emissive + (_LightColor0.rgb*lerp((node_9548_if_leA*(node_8224*_ShadowColor.rgb))+(node_9548_if_leB*node_1239),node_1239,node_9548_if_leA*node_9548_if_leB));
...
////// Lighting:
                ...
                float3 node_8224 = Diffuse;
                float3 node_1239 = (node_8224*_LightColor.rgb);
                float3 finalColor = (_LightColor0.rgb*lerp((node_9548_if_leA*(node_8224*_ShadowColor.rgb))+(node_9548_if_leB*node_1239),node_1239,node_9548_if_leA*node_9548_if_leB));
